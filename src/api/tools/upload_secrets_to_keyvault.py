...
Usage:
    python upload_secrets_to_keyvault.py --keyvault-name <vault_name> --env-file <path_to_env_file>

Example:
    python upload_secrets_to_keyvault.py --keyvault-name my-keyvault --env-file .env
"""
